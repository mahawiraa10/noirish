<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Update your account's profile information and additional details.
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="preferences" :value="__('Preferences (e.g., shoe style, favorite color)')" />
            <x-text-input id="preferences" name="preferences" type="text" class="mt-1 block w-full" :value="old('preferences', $user->preferences)" />
